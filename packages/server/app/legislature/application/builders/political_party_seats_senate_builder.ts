...
export class PoliticalPartySeatsSenateBuilder {
  ...
  public withNumberOfSeats(numberOfSeats: number): PoliticalPartySeatsSenateBuilder {
    this.numberOfSeats = numberOfSeats;
    return this;
  }

  public withPoliticalPartyId(politicalPartyId: number): PoliticalPartySeatsSenateBuilder {
    this.politicalPartyId = politicalPartyId;
    return this;
  }

  public withSenateId(senateId: number): PoliticalPartySeatsSenateBuilder {
