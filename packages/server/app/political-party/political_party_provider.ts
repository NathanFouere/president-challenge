...
export default class PoliticalPartyProvider extends AppProvider {
  public async boot(): Promise<void> {
    ...
    const { default: GetPoliticalPartyDefinitionsOfGameDefinitionQueryHandler } = await import(
      '#political-party/infrastructure/query/get_political_party_definitions_of_game_definition_query_handler'
    );
    this.app.container.bind(IGetPoliticalPartyDefinitionsOfGameDefinitionQueryHandler, () => {
      return new GetPoliticalPartyDefinitionsOfGameDefinitionQueryHandler();
    });
