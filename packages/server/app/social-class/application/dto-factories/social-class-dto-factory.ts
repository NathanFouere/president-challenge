import type { SocialClassDto } from '@president-challenge/shared/dist/social-class/social-class-dto.js';
...
export class SocialClassDtoFactory {
  ...
  public async createFromSocialClass(socialClass: SocialClass): Promise<SocialClassDto> {
    return {
      ...
      financialFlowDatas: this.financialFlowDtoFactory.generateFinancialFlowsDatasFromFinancialFlows(socialClass.financialFlows),
    };
  }
}
